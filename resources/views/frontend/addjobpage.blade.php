...
<div class="dashboard-container">
	...
	<div class="dashboard-content-container" data-simplebar>
		<div class="dashboard-content-inner" >
			...
			<!-- Row -->
			<div class="row">
        {!! Form::open(['url' => route('job-post.store'),'files'=> true]) !!}
				<!-- Dashboard Box -->
				<div class="col-xl-12">
							...
							<div class="row">
								<div class="col-xl-4">
									<div class="submit-field">
										<h5>Job Title</h5>
                    {{-- {!!Form::text('job_title', "john", ['class' => 'with-border'])!!} --}}
          {{Form::text("job_title", "", [ "class" => "with-border",]) }}
                        ...
                        {!!Form::text("location", "", ['class' => 'with-border'], ['id' => 'autocomplete-input'], ["placeholder" => 'Type Address']);!!}
                          ...
                          {!!Form::number('min_salary', "", ['class' => 'with-border'], ["placeholder" => 'Min']);!!}
                        ...
                        {!!Form::number('max_salary', "", ['class' => 'with-border'], ["placeholder" => 'Max']);!!}
													<i class="currency">USD</i>
												</div>
											</div>
										</div>
                        ...
                        {!!Form::text('tags', "", ['class' => 'keyword-input with-border'], ["placeholder" => "e.g. job title, responsibilites"]);!!}
                    ...
                    {!!Form::textarea("job_description", "", [ "class" => "with-border", 'cols'=>"30", 'rows'=>"5"]);!!}
				...
				<div class="col-xl-12">
					{{-- <a href="#" class=""><i class="icon-feather-plus"></i> Post a Job</a> --}}
          {!!Form::submit('Post a Job', ["class" => "button ripple-effect big margin-top-30"]);!!}
				</div>
			</div>
      {!! Form::close() !!}
